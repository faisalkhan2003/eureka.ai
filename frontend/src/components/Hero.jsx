    ...
    <div
      ...
      <div className="px-4 py-10 md:py-20">
        ...
        <motion.p
          ...
          An intelligent research companion simplifying discovery, learning, and publishing.
        </motion.p>
        <motion.div
          initial={{
            opacity: 0,
          ...
          <button
          onClick={()=>navigate('/research/chatbot')}
            className="w-60 cursor-pointer transform rounded-lg bg-black px-6 py-2 font-medium text-white transition-all duration-300 hover:-translate-y-0.5 hover:bg-gray-800 dark:bg-white dark:text-black dark:hover:bg-gray-200">
            Explore Now
          </button>
        </motion.div>
      </div>
